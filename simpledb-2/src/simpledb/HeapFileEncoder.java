 ...
 * data in the appropriate format for simpledb heap pages Pages are padded out to a specified length, and written
...
public class HeapFileEncoder {
	...
	/**
	 * Convert the specified tuple list (with only integer fields) into a binary page file. <br>
	 *
	 ...
	 * @see HeapFile
	 * @param tuples
	 *            the tuples - a list of tuples, each represented by a list of integers that are the field values for
	 *            that tuple.
	 * @param outFile
	 ...
	 * @throws IOException
	 *             if the input/output file can't be opened or a malformed input line is encountered
	 */
