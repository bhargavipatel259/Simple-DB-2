...
public  class LogicalPlan {
    ...
    */
     ...
     * @throws DbException 
     */ 
    public DbIterator physicalPlan(TransactionId t, HashMap<String,TableStats> baseTableStats, boolean explain) throws ParsingException, DbException {
        Iterator<LogicalScanNode> tableIt = tables.iterator();
        ...
        while (filterIt.hasNext()) {
            ...
            if (ftyp == Type.INT_TYPE)
                ...
                f = new StringField(lf.c, ((String)lf.c).length());
