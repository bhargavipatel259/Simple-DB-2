...
public class Parser {
    ...
    static void processExpression(TransactionId tid, ZExpression wx, LogicalPlan lp) throws simpledb.ParsingException, DbException {
    ...
    public static LogicalPlan parseQueryLogicalPlan(TransactionId tid, ZQuery q) throws IOException, Zql.ParseException, simpledb.ParsingException, DbException { 
        @SuppressWarnings("unchecked")
    ...
    public static DbIterator parseQuery(TransactionId tid, ZQuery q) throws IOException, Zql.ParseException, simpledb.ParsingException, DbException {
        ...
        if (s.getValues() != null) {
            ...
            for (ZExp e : values) {
                ...
                if (zc.getType() == ZConstant.NUMBER) {
                    ...
                    StringField f= new StringField(zc.getValue(), ((String)zc.getValue()).length());
                    t.setField(i,f);
                } else {
    ...
    public static LogicalPlan generateLogicalPlan(TransactionId tid, String s) throws simpledb.ParsingException, DbException {
