...
public class TupleDesc {
	...
	public Type getType(int i) throws NoSuchElementException {
		// some code goes here
		/**
		 * Here it will search for all field types from index zero till the value of index is less than value of numFields and will return field type of that index.
		 */
		if(i < 0 && i >= numFields())
		{
